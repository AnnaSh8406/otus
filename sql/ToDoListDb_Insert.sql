...
BEGIN
  FOR i IN 1..5 LOOP
	SELECT ('2025-12-01 10:00:00'::timestamp + (('2025-12-12 12:00:00'::timestamp - '2025-12-01 10:00:00'::timestamp)* random())) INTO "RandomRegisteredAt";
  ...
  END LOOP;
  FOR i IN 1..10 LOOP
  	SELECT "UserId" INTO "RandomUserId" FROM "ToDoUser" ORDER BY random() LIMIT 2;
	SELECT ('2025-12-01 10:00:00'::timestamp + (('2025-12-12 12:00:00'::timestamp - '2025-12-01 10:00:00'::timestamp)* random())) INTO "RandomRegisteredAt";
  ...
  FOR i IN 1..100 LOOP
  	SELECT "UserId" INTO "RandomUserId" FROM "ToDoUser" ORDER BY random() LIMIT 2;
  	SELECT "Id" INTO "RandomListId" FROM "ToDoList" ORDER BY random() LIMIT 2;
	  
	SELECT ('2025-12-01 10:00:00'::timestamp + (('2025-12-12 12:00:00'::timestamp - '2025-12-01 10:00:00'::timestamp)* random())) INTO "RandomRegisteredAt";
	SELECT ('2025-11-01 10:00:00'::timestamp + (('2025-11-12 12:00:00'::timestamp - '2025-11-01 10:00:00'::timestamp)* random())) INTO "RandomStateChangedAt";
	SELECT ('2025-10-01 10:00:00'::timestamp + (('2025-10-12 12:00:00'::timestamp - '2025-10-01 10:00:00'::timestamp)* random())) INTO "RandomDeadLine";
